...
!function () {
    ...
    var e = window.layui && layui.define, t = {
        ...
        c = "layui-laydate-static", m = "layui-laydate-list", u = "laydate-selected", h = "layui-laydate-hint",
        y = "laydate-day-prev", f = "laydate-day-next", p = "layui-laydate-footer", g = ".laydate-btns-confirm",
...
!function (e, t) {
    ...
    var ve = function (e) {
        ...
        var b, w, T, C, E, N, k, S, A, D, j, L, H, q, _, F, M, O, R, P = "sizzle" + 1 * new Date, B = e.document, W = 0, I = 0,
            $ = n(), z = n(), X = n(), U = function (e, t) {
                return e === t && (j = !0), 0
            ...
            ce = new RegExp("=" + ne + "*([^\\]'\"]*?)" + ne + "*\\]", "g"), fe = new RegExp(oe), de = new RegExp("^" + re + "$"),
            pe = {
                ID: new RegExp("^#(" + re + ")"),
                CLASS: new RegExp("^\\.(" + re + ")"),
                TAG: new RegExp("^(" + re + "|[*])"),
    ...
    var zt = /#.*$/, Xt = /([?&])_=[^&]*/, Ut = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
        ...
        Gt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Kt = {}, Qt = {}, Zt = "*/".concat("*"), en = Bt.href,
    ...
    pe.extend({
        ...
        ajax: function (t, n) {
            ...
            var i, o, a, s, u, l, c, f, d = pe.ajaxSetup({}, n), p = d.context || d,
                h = d.context && (p.nodeType || p.jquery) ? pe(p) : pe.event, g = pe.Deferred(), m = pe.Callbacks("once memory"),
...
!function (e, t) {
    ...
    l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
        ...
        var s = [o.innerWidth(), o.innerHeight()], f = o.find(l[1]).outerHeight() || 0, c = o.find("." + l[6]).outerHeight() || 0,
            u = function (e) {
...
layui.define("jquery", function (i) {
    "use strict";
    var t = layui.$, a = (layui.hint(), layui.device()), e = "element", l = "layui-this", n = "layui-show", s = function () {
        this.config = {}
    };
        ...
        h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
            tabClick: function (i, a, s, o) {
                ...
                var c = s || t(this), a = a || c.parent().children("li").index(c),
                    ...
                    u = o.bodyElem ? t(o.bodyElem) : r.children(".layui-tab-content").children(".layui-tab-item"), d = c.find("a"),
                    h = r.attr("lay-filter");
...
layui.define("layer", function (e) {
    ...
    var i = layui.$, t = layui.layer, n = layui.hint(), a = layui.device(), o = {
        ...
        }, r = "upload", u = "layui-upload-file", c = "layui-upload-form", f = "layui-upload-iframe", s = "layui-upload-choose",
        p = function (e) {
            var t = this;
...
layui.define("layer", function (e) {
    "use strict";
    var t = layui.$, i = layui.layer, a = layui.hint(), n = layui.device(), l = "form", r = ".layui-form", s = "layui-this",
        o = "layui-hide", u = "layui-disabled", c = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "必填项不能为空"],
    ...
    c.prototype.set = function (e) {
        ...
        var n = this, c = t(r + function () {
            ...
            select: function () {
                ...
                f.each(function (e, l) {
                    var r = t(this), o = r.next("." + a), c = this.disabled, d = l.value, f = t(l.options[l.selectedIndex]),
                        y = l.options[0];
    ...
    var d = function () {
        var e = t(this), a = f.config.verify, s = null, o = "layui-form-danger", u = {}, c = e.parents(r),
            d = c.find("*[lay-verify]"), y = e.parents("form")[0], v = c.find("input,select,textarea"), h = e.attr("lay-filter");
...
layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    "use strict";
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, o = layui.hint(), r = layui.device(),
        d = {
        ...
        }, s = "table", u = ".layui-table", h = "layui-hide", f = "layui-none", y = "layui-table-view", p = ".layui-table-header",
        m = ".layui-table-body", v = ".layui-table-main", g = ".layui-table-fixed", x = ".layui-table-fixed-l",
        b = ".layui-table-fixed-r", k = ".layui-table-tool", C = ".layui-table-page", w = ".layui-table-sort",
        N = "layui-table-edit", F = "layui-table-hover", W = function (e) {
    ...
    S.prototype.config = {limit: 10, loading: !0, cellMinWidth: 60, text: {none: "无数据"}}, S.prototype.render = function () {
        ...
        u.on("mousemove", function (e) {
            ...
            var e = t(this).prev(), i = a.layBody.find('input[name="layTableCheckbox"]'), l = e.parents("tr").eq(0).data("index"),
                n = e[0].checked, o = "layTableAllChoose" === e.attr("lay-filter");
...
layui.define("jquery", function (e) {
    ...
    var i = layui.$, n = (layui.hint(), layui.device(), {
        ...
        }), t = "carousel", a = "layui-this", l = ">*[carousel-item]>*", o = "layui-carousel-left", r = "layui-carousel-right",
        d = "layui-carousel-prev", s = "layui-carousel-next", u = "layui-carousel-arrow", c = "layui-carousel-ind",
        m = function (e) {
            var t = this;
...
layui.define(["layer", "form"], function (t) {
    ...
    c.prototype.set = function (t) {
        ...
        i = i || {};
        var a = this, n = a.config, r = "layui-layedit", c = e("#" + t), u = "LAY_layedit_" + ++a.index, d = c.next("." + r),
